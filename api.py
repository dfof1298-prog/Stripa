...
def generate_python_file(target_url, email, pk_live, addnonce, payment_id, gateway_response):
    """توليد ملف بايثون زي السورس الأصلي"""
...
def run_code(target_url):
    try:
        ...
        response = r.post('https://api.stripe.com/v1/payment_methods', headers=headers, data=stripe_data)
        payment_id = response.json()['id']
    ...
    try:
        ...
        for update in updates:
            ...
            if "message" in update:
                ...
                if text == "/start":
                    send_msg(chat_id, "Send me a link\nI will send you a Python file with gateway response")
                    ...
                    if filename and os.path.exists(filename):
                        ...
                        send_msg(chat_id, "✅ Python file sent!")
